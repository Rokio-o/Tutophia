...
// ── Read-only section card (mirrors sectionCard from profile-nav-student-wdgt) ─
...
// ─────────────────────────────────────────────────────────────────────────────
//  AdminViewStudentApplication
// ─────────────────────────────────────────────────────────────────────────────

class AdminViewStudentApplication extends StatefulWidget {
  final StudentApplicationModel application;
  final void Function(ApplicationStatus status, {String? rejectReason})
  onStatusChanged;

  const AdminViewStudentApplication({
    super.key,
  ...
  @override
  State<AdminViewStudentApplication> createState() =>
      _AdminViewStudentApplicationState();
}

class _AdminViewStudentApplicationState
    extends State<AdminViewStudentApplication> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            // ── Student Description ───────────────────────────────────────────
            _sectionCard("Student Description", app.bio),
            ...
            _sectionCard(
              "Subjects Needed",
              app.subjectsNeeded.isEmpty ? '—' : app.subjectsNeeded.join(', '),
            ),

            // ── Availability ──────────────────────────────────────────────────
            _sectionCard("Availability", app.availability),
